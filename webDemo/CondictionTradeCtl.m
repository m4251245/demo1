...
#define TradeDataFile_Name                          @"trade_archive_1_7.data"
...
+(id) loadDataFromFile
{
    ...
    //从序列化文件中取得数据
    @try {
        id archieveData = [self unArchiverFromFile:TradeDataFile_Name];
...
////    NSString *homePath = [homeDictionary stringByAppendingPathComponent:@"Account.data"];
//    NSString *homePath  = [NSString stringWithFormat:@"%@",[[NSBundle mainBundle] resourcePath]];
    
    NSString *stringPath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex: 0];
    NSString *homePath = [stringPath stringByAppendingPathComponent:@"trade_archive_1_8.data"];
